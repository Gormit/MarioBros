package by.gormit.mariobros.Screens;
...
import by.gormit.mariobros.Controller;
...
import by.gormit.mariobros.Tools.B2WorldCreator;
import by.gormit.mariobros.Tools.WorldContactListener;
...
public class PlayScreen implements Screen {
    ...
    public void update(float dt) {
        ...
        if (player.currentState == Mario.State.GOAL) {
...
//        b2dr.render(world, gamecam.combined);
    ...
    public boolean stageClear() {
        if (player.currentState == Mario.State.GOAL && player.getStateTimer() > 4) {
            return true;
        }
        return false;
    }
