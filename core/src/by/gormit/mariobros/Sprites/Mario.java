package by.gormit.mariobros.Sprites;
...
public class Mario extends Sprite {
    public enum State {FALLING, JUMPING, STANDING, RUNNING, GROWING, DEAD, GOAL}
    ...
    public void goal() {
        MarioBros.manager.get("audio/music/mario_music.ogg", Music.class).stop();
        MarioBros.manager.get("audio/sounds/smb_stage_clear.wav", Sound.class).play();
